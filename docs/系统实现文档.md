...
|              | 王永瑶                                                                                                                                | 李京昊                                                                                                                       | 卓乐                                                                                                                                                |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| 系统设计阶段 | 前期调研、分析系统需求设计 `<br>`数据库系统的概念模式（E-R图）`<br>`设计数据库关系模式 `<br>`根据需求设计前端网页基本布局与模块 | 前期调研、分析系统需求设计 ``数据库系统的概念模式（E-R图）``编写数据流图与数据元素表<br />根据需求设计前端网页基本布局与模块 | 前期调研、分析系统需求设计 ``数据库系统的概念模式（E-R图）``设计数据库系统的逻辑模式并将所有关系规范化到 3NF `<br>`设计后端架构与数据库的主要功能 |
| 系统实现阶段 | 用户相关功能(用户信息，游戏搜索功能，交易功能等)`<br>`主页界面 `<br>`前后端交互 `<br>`部分游戏详情页面                          | 游戏热度页面 `<br>`游戏详情页面 `<br>`用户登陆注册页面<br />优惠界面<br />路由设计<br />前后端交互与测试                 | 后端代码编写 `<br>`管理员模式设计 `<br>`前后端交互接口设计                                                                                      |
