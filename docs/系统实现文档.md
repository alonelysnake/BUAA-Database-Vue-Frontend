...
为防止用户密码过短、过于简单而导致密码被暴力破解，我们规定密码长度必须大于8位，并且要求字母和数字结合。在用户注册或修改密码时，对用户输入的密码利用正则表达式进行格式验证，如果不符合系统规定则提示用户重新设置密码。
...
- 主页轮播图
  ...
  ![image-20221223212147199](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\轮播图.png)

- 主页咨询栏

  由管理员根据steam最新、最热新闻设置对应新闻，用户可点击跳转到steam对应的新闻页面。

  ![image-20221223212419131](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\资讯.png)

- 用户个人信息

  用户可以查看并修改自己的个人信息，包括头像、交易情况、昵称、邮箱、个人简介等。

  ![image-20221223212652697](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\个人信息.png)

- 修改个人密码

  在个人信息页面点击下方”修改密码“按钮，在输入原密码，以及两次确认新密码后，即可成功修改密码。

  ![image-20221223222939946](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\修改密码.png)
...
- 买家中心
  ...
  - 订单展示
    ...
    ![image-20221223221516272](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\买家订单.png)
...
- 卖家中心
  ...
  - 商品展示
    ...
    ![image-20221223215540947](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\商品页面.png)

  - 上架/修改/删除/批量删除商品

    用户可以点击左上角“添加商品”按钮实现商品上架，点击对应商品右侧“编辑”按钮实现修改商品，点击对应商品右侧“删除”按钮实现删除商品，选中多个商品后点击左上角“批量删除”按钮实现批量删除商品。

    ![image-20221223215523446](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\添加商品卡片.png)

  - 订单展示

    用户可以“卖家中心-订单”页面中查看并修改自己售出的商品状态，为用户提供修改、删除、批量删除、筛选订单、筛选、排序、按订单号或游戏名搜索订单等功能。用户通过右键点击对应商品可以进行发货、退款、删除等操作。![image-20221223220343601](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\卖家订单.png)

- 查看其他用户信息

  用户可以作为访客查看卖家的个人信息，了解卖家的交易情况。

  ![image-20221223221935361](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\访客信息.png)

- 查看其他用户上架商品

  用户可以作为访客查看卖家已上架的商品，并可以点击对应商品右侧的“购买”按钮购买商品。

  ![image-20221223222401093](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\访客商品.png)

- 用户购买商品全过程

  - 在游戏详情页或卖家页面点击购买商品，执行假支付后将提交交易订单，交易状态为“已付款”。

    ![image-20221223224325149](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\购买过程1.png)

    之后在自己的“买家中心”页面可以找到该订单。

    ![image-20221223224521391](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\购买过程2.png)

  - 商品被购买后，卖家可以在自己的“卖家中心-订单”界面找到该订单，并右键点击发货。![image-20221223225015106](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\购买过程3.png)

  - 卖家发货后，可以看到对应订单状态由“已付款”变为“已发货”，用户右键点击订单即可确定收货。

    ![image-20221223225212891](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\购买过程4.png)

  - 最后用户可以右键点击订单选择评价交易。至此整个交易完成。

    ![image-20221223225336447](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\购买过程5.png)

    ![image-20221223225419186](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\购买过程6.png)
...
- 使用**Storage机制**保存用户的历史搜索记录。在用户搜索游戏后，将游戏id和游戏名称存入localStorage。当用户再次点击搜索框时，将读取localStorage中的信息，并将游戏名展示出来。
  ...
  ![image-20221223181108339](C:\Users\83782\Desktop\数据库\FrontEnd\BUAA-Database-Vue-Frontend\docs\img\搜索框.png)
...
用户可以按自己的偏好，按游戏的不同特性设置多个条件进行筛选，即进行**数据钻取**。对于游戏的价格数据，我们使用Echarts包，支持用户**多粒度**地对数据进行统计分析。对于展示出的数据折线图，用户可以保存至本地进行分析。（ljh补充一下）
